...
export function SportBridge({
  ...
  return (
    <section
      ...
      className="relative w-full min-h-[72vh] bg-bg px-5.5 sm:px-9 lg:px-16 flex flex-col justify-center py-20 sm:py-24 overflow-hidden scroll-mt-24 border-y-4 border-ink/20 pointer-events-auto"
    >
