...
export function CTASection() {
  return (
    <section
      id="legends"
      data-surface="outro"
      className="relative w-full min-h-[80vh] px-5.5 sm:px-9 lg:px-16 pt-26 sm:pt-28 lg:pt-32 pb-24 flex items-center justify-center text-center overflow-hidden scroll-mt-24"
    >
